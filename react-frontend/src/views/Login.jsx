...
function Login(props) {
  ...
  return (
    <div className="flex flex-col bg-neutral-900 h-screen items-center justify-evenly text-white relative">
      ...
      <form
        className="flex w-[90%] relative flex-col sm:w-[90%] md:w-[70%] lg:w-[50%] rounded-sm p-2 border-white border-[1px] border-opacity-60 shadow-bottom-right shadow-neutral-500 h-[350px] mb-10">
